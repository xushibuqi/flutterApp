...
class FileTransferPageMobile extends StatefulWidget {
  final String url;

  const FileTransferPageMobile({Key? key, required this.url}) : super(key: key);

  @override
  _FileTransferPageState createState() => _FileTransferPageState();
}

class _FileTransferPageState extends State<FileTransferPageMobile> {
